...
6. Call shortcode to your wordpress editor directly by using [vertical-carousel-slider] .
7. Call shortcode to your php template file using  <?php echo do_shortcode('[vertical-carousel-slider]'); ?> .
